...
export function HeroFeatures() {
  return (
    <section className="relative pt-24 pb-16 sm:pt-28 overflow-hidden bg-gradient-to-br from-primary-50 via-white to-secondary-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
      {/* Background Elements */}
